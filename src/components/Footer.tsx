        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
          <div className='mb-4 md:mb-0'>
            ...
            <p className='font-helvetica text-sm mt-1 text-gray-300'>
              © {new Date().getFullYear()} Noto App. Todos os direitos
              reservados.
            </p>
          </div>
          ...
          <div className='flex flex-col md:flex-row gap-6 md:gap-12'>
            <div>
              <h3 className='font-helvetica text-sm uppercase tracking-wider mb-2'>
                Links
              </h3>
            ...
            <div>
              ...
              <ul className='font-helvetica text-sm text-gray-300 space-y-1'>
                <li>
                  <a href='mailto:glima7591@gmail.com' className='hover:text-white transition-colors'>
                    Contato
                  </a>
                </li>
              </ul>
